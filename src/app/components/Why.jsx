    ...
    <section className="section flex items-center" id="why">
      <div className="container mx-auto">
        ...
        >
          ...
          the competition. From the moment ypu engage wit hus, we strive to
        ...
        className="flex flex-wrap justify-center xl:grid xl:grid-cols-3 gap-4 xl:gap-y-0 xl:gap-x-[30]">
          <div className="flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0">
            ...
            <p className="hidden xl:flex">We prioritize your need and we go above and beyoud to ensure your
             experience with us is nothing short of outstanding.</p>
          </div>
